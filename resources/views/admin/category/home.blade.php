                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                        <a href="{{ route('category.edit', ['category' => $category->id]) }}" type="button" class="btn btn-warning">Editar</a>
                                        <a href="{{ route('category.destroy', ['category' => $category->id]) }}" type="button" class="btn btn-danger">Excluir</a>
                                </td>
                            </tr>
                            @empty
                            <tr>
